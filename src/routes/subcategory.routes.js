...
import { createSubCategoryController, getSubCategoryController, updateSubCategoryController, deleteSubCategoryController, fatchCategoryController } from '../controllers/subcategory.controller.js';
...
router.get('/buyer/subcategories', userAuthMiddleware, fatchCategoryController);
